...
def run_single(classifier):
    ...
    d[Website.Tag.SFH.value]                    = float(input("  SFH                                     [-1, 0, 1]        "))
    ...
    d[Website.Tag.REDIRECT.value]               = float(input("  Redirect                                [    0, 1]        "))
    d[Website.Tag.MOUSE_OVER.value]             = float(input("  On Mouseover                            [-1,    1]        "))
